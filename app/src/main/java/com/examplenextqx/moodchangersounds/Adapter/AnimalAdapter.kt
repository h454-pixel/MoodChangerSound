...
import com.examplenextqx.moodchangersounds.AnimalActivity
...
class AnimalAdapter(var List:ArrayList<ModelF>, var context: AnimalActivity)  : RecyclerView.Adapter<AnimalAdapter.ViewHolder>(){
